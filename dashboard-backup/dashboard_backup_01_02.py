...
def compute_combined_cp(wind_share=1.0) :
...
def update_slider(period_radio,_):
...
def update_side_graph(click, fig_choice, year):
    ...
    if fig_choice == "Climate indices and LP events" :
        ...
        for index in indices :
            fig.add_trace(go.Scatter(x=merge.timestamp, y=merge[index], line={'color': 'lightgrey',"width":1}, name = index,legendgroup=index, showlegend=False, visible=(False if index!="nao" else True)))
